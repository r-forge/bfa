...
#' @param scale.name label for the intensities
#' @usage plot_loadings(x, xlabel=NA, ylabel=NA, 
#' color=c("#053061", "#2166AC", "#4393C3", "#92C5DE", "#D1E5F0", "#F7F7F7", 
#'      "#FDDBC7", "#F4A582", "#D6604D", "#B2182B", "#67001F"), 
#'      sorting=NA, scale.name="Loading", type=c("color","line"))
#' @export

plot_loadings <- function(x, xlabel=NA, ylabel=NA, 
                    color=c("#053061", "#2166AC", "#4393C3", 
                            "#92C5DE", "#D1E5F0", "#F7F7F7", 
                            "#FDDBC7", "#F4A582", "#D6604D", 
                            "#B2182B", "#67001F"), 
                    sorting=NA, scale.name="Loading", type="color") {
  if (class(x)=="bfa") {
